                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id="rolesFrom" method="POST" action="{{ route('roles.update',$role->id) }}">
                                @csrf
                                @method("PUT")
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="exampleInputName">Name</label>
                                        <input type="text" name="name" value="{{$role->name}}" class="form-control" id="exampleInputName"
                                ...
                                <div class="row m-2">
                                    ...
                                    <div class="col-lg-12 my-2">
                                        <div class="icheck-primary d-inline">
                                            <input type="checkbox" class='permission' id="allPermission" {{$total_count == count($rolePermissions_array) ? 'checked' : ''}}>
                                                ...
                                                <div class="card-header">
                                                    <div class="icheck-primary d-inline ml-2">
                                                        <input type="checkbox" id="{{ $key }}"
                                                            value="{{ $key }}"
                                                            class="parent permission" {{ count($permission) == isset($parent_array[$key]) ? 'checked' : '' }}>
                                                    ...
                                                    <ul class="todo-list" data-widget="todo-list">
                                                        ...
                                                        @foreach ($permission as $k => $value)
                                                            ...
                                                            <li class="pl-4 shadow">
                                                                <!-- checkbox -->
                                                                <div class="icheck-primary d-inline ml-2">
                                                                    <input {{in_array($value->name, $rolePermissions_array) ? 'checked' : ''}} type="checkbox"
