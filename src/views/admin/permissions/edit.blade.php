                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id="permissionFrom" method="POST" action="{{ route('permissions.update', $title) }}">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                            ...
                                            @if ($k == 0)
                                                <div class="col-md-6">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="btn btn-primary" id="more"
                                                            data-id="{{ count($permissions) }}"><i
